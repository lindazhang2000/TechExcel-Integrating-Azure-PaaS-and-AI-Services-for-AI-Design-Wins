...
def generate_extractive_summary(call_contents):
    ...
    if not call_contents:
        st.error("Call contents are empty. Please provide valid call contents.")
        return ''
    ...
    if not joined_call_contents:
        st.error("Joined call contents are empty. Please provide valid call contents.")
        return ''
